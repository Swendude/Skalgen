...
exports.study = {
    ...
    effect: (seed, now, agent) => [
        (0, manipulations_1.changeAgentResource)(now, agent, "knowledge", 1),
...
exports.train = {
    ...
    effect: (seed, now, agent) => [
        (0, manipulations_1.changeAgentResource)(now, agent, "might", 1),
...
exports.politics = {
    ...
    effect: (seed, now, agent) => [
        (0, manipulations_1.changeAgentResource)(now, agent, "influence", 1),
...
exports.smear = {
    ...
    effect: (seed, now, agent) => {
        ...
        if (myRoll > theirRoll) {
            return [
                (0, manipulations_1.changeAgentResource)(now, chosenTarget, "influence", -1),
