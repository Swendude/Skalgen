...
exports.killOtherAgent = {
    ...
    effect: (seed, now, agent, artefact) => {
        ...
        return [
            (0, ramda_1.pipe)((0, manipulations_1.killAgent)(chosenTarget), (0, manipulations_1.removeArtefactFromAgent)(agent, artefact))(now),
...
exports.gainMight = {
    ...
    effect: (seed, now, agent, artefact) => {
        ...
        return [
            (0, ramda_1.pipe)((0, manipulations_1.changeAgentResource)(agent, "might", 1), (0, manipulations_1.removeArtefactFromAgent)(agent, artefact))(now),
...
exports.reviveOtherAgent = {
    ...
    effect: (seed, now, agent, artefact) => {
        ...
        const chosenTarget = (0, fates_1.makeChoice)(fate, now.agents.filter((_agent) => _agent.id !== agent.id && _agent.dead));
        return [
            (0, ramda_1.pipe)((0, manipulations_1.reviveAgent)(chosenTarget), (0, manipulations_1.removeArtefactFromAgent)(agent, artefact))(now),
